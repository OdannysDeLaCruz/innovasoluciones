	...
	<section class="col-10 col-sm-10 col-md-10 contenido_principal">
		...
		<section class="contenedor_tabla">
			...
			<form class="form_crear_producto form_editar_producto" id="form_editar_producto" action="{{ route('createProductos') }}" method="post" enctype="multipart/form-data">
				...
				@if($producto_detalle)
					@foreach($producto_detalle as $producto)
					
					@endforeach
				@endif
				
				<div class="form-group bloque-detalle-producto">
	                <!-- Nombre -->
				...
				<section class="form-group section_subir_imagenes">
					<h2 class="section_subir_imagenes_titulo">SUBIR IMAGEN PRINCIPAL</h2>
					<input type="file" class="form-control section_subir_imagenes_input" id="producto_imagen" name="producto_imagen" value="{{ old('producto_imagen') }}" required>
					...
					<h2 class="section_subir_imagenes_titulo">SUBIR IMAGENES COMPLEMENTARIAS <small>(Max 4)</small></h2>
	               ...
	               <!--  @if ($errors->has('producto_imgs_referencia'))
	                ...
	                @endif -->
					<h2 class="section_subir_imagenes_titulo">SUBIR VIDEOS COMPLEMENTARIAS</h1>
				...
				<div class="form_botones_accion">
					<button type="submit" class="btn_actualizar" id="btn-crear-producto"> Actualizar </button>
				</div>
			</form>
		</section>
	</section>
